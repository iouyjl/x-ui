...
# --- 配置区 ---
# 请将这里的 URL 替换为你 GitHub 上编译好的二进制文件真实直链
GITHUB_URL="https://github.com/iouyjl/x-ui/raw/refs/heads/main/pve_hw_api"
...
# 4. 创建 Systemd 服务（实现开机自启、崩溃重启、日志管理）
